...
// // 根据二级域名分组的策略
// import { getOtherConfig } from '~/service/onesConfig'
//
...
//     console.log(res)
//     //   // 判断是否开启自动分组
//     if (!res.enableAutoGroup) {
//       return
//     }
//
//     const strategy = secDomainStrategy
...
//     }
//   })
//   // browser.storage.sync.get(Object.keys(DEFAULT_CONFIG), (config) => {
...
//             browser.tabs.group({ tabIds, groupId: tabGroups[0].id })
//           }
//           else {
//             browser.tabs.group({ tabIds }).then((groupId) => {
//               browser.tabGroups.update(groupId, { title: groupTitle })
//             })
//           }
//         })
