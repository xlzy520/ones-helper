  ...
  <div class="">
    <div class="">
      <n-alert title="温馨提示" type="info">
        <div>
          下载新版本后，需要 <b style="color: #db2777">删除之前的文件夹</b>，然后将新的文件夹
          <b style="color: #db2777">重命名</b>， 也就是删除括号及括号里面的内容
        </div>
        <div>
          例如：默认解压之后是<b style="color: #22c55e">ONES Helper</b>，下载解压后新的文件夹名为
          <b style="color: #22c55e">ONES Helper 2</b>，需要将后面的
          <b style="color: #22c55e"> 2 </b>删除
        </div>
      </n-alert>
